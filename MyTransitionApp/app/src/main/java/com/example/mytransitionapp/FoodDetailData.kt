...
object FoodDetailData {
    ...
    val detailData: ArrayList<FoodDetail>
        get() {
            val detailData: ArrayList<FoodDetail> = arrayListOf<FoodDetail>()
            for (position in foodDetail.indices) {
                val detail = FoodDetail()
                detail.detailPhoto = foodDetailPhoto[position]
                detail.detailText = foodDetail[position]
